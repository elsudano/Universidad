 ...
 */
public class QuestionsResizeImage extends Questions {
     ...
     */
    public QuestionsResizeImage(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        // uso lo siguiente para poner el tamaño de la imagen origen en los spinners
        VentanaInterna vi = (VentanaInterna) this.myParent.getEscritorio().getSelectedFrame();
    ...
    private void initComponents() {
        ...
        jRadioButtonRellenar = new javax.swing.JRadioButton();
        jRadioButtonTransparente = new javax.swing.JRadioButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jPanelContent.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5));
        jPanelContent.setPreferredSize(new java.awt.Dimension(200, 120));
        ...
        jPanelTransparencia.setLayout(new javax.swing.BoxLayout(jPanelTransparencia, javax.swing.BoxLayout.PAGE_AXIS));

        buttonGroupOptions.add(jRadioButtonRellenar);
        jRadioButtonRellenar.setSelected(true);
        jRadioButtonRellenar.setText("Rellenar con Blanco");
        jPanelTransparencia.add(jRadioButtonRellenar);

        buttonGroupOptions.add(jRadioButtonTransparente);
        jRadioButtonTransparente.setText("Dejar Transparente");
        jPanelTransparencia.add(jRadioButtonTransparente);
    ...
    public void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        vi.getLienzo().resizeImage((int)this.jSpinnerAncho.getValue(), (int)this.jSpinnerAlto.getValue(), this.jRadioButtonTransparente.isSelected());
        this.dispose();
    }
    ...
    private javax.swing.JRadioButton jRadioButtonRellenar;
    private javax.swing.JRadioButton jRadioButtonTransparente;
