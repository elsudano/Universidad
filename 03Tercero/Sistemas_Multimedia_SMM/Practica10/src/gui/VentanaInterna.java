...
public class VentanaInterna extends javax.swing.JInternalFrame{
     ...
     * pintar la imagen.
     * 
     * @param li [in] de tipo Lienzo2DImage sera en donde pintaremos las imagenes.
     */
     ...
     * 
     * Como las ventanas internas de java no tienen un evento de resize
     * utilizo el panel que sirve como lienzo para usar su evento resize
     * y como la ventanta tiene un BorderLayout pues se redimenciona a la par
     * que la ventana interna.
     * 
     * Simpremente cojo la imagen que tiene el lienzo y la vuelvo a setear
     * de esa manera como el evento de setImage auto calcula la posición de
     * la imagen correcta segun el tamaño del lienzo solo se calcula la
     * posición de la imagen cuando se setea.
     * 
