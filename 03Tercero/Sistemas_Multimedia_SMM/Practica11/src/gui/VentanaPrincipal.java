...
public class VentanaPrincipal extends javax.swing.JFrame {
     ...
     * escritorio pero asi es mas rapido. Cuando se cierra una ventana sin
    ...
    private void initComponents() {
        ...
        jMenuItemTintar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemTintarActionPerformed(evt);
            }
        });
        ...
        jMenuItemSubstract.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemSubstractActionPerformed(evt);
            }
        });
        ...
        jMenuItemSepia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemSepiaActionPerformed(evt);
            }
        });
        ...
        jMenuItemEfecto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemEfectoActionPerformed(evt);
            }
        });
    ...
    /**
     * Con este método quitamos muchas lineas de codigo por que siempre
     ...
     * métodos,
     *
     * Hay que destacar que la imagen original se almacena sin modificiacones
     * ninguna, que la imagen temporal se almacena modificando el tipo de imagen
     * de la original a la que se pasa por parametros, y que para que funcionen
     * todos los métodos se tiene que poner a null la imagen original una vez
     * terminado el proceso de retoque en el caso de las opciones del menu se
    ...
    private boolean canApply(int t) {
        ...
        if (this.vi != null) {
            ...
            this.vi.getLienzo().setTypeImage(t);
            this.imgTemp = this.vi.getLienzo().getImage();
            // para el deshacer
    ...
    private void jMenuItemSenoFunctionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemSenoFunctionActionPerformed
        if (this.canApply(BufferedImage.TYPE_INT_ARGB)) {
            try {
                ...
                this.vi.getLienzo().setImage(ltop.filter(this.imgTemp, null));
                this.imgOrigen = this.imgTemp = null;
                this.setEnabledUndo(true);
            } catch (Exception e) {
    ...
    private void jMenuItemRescaleOPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemRescaleOPActionPerformed
        ...
        if (this.canApply(BufferedImage.TYPE_INT_ARGB)) {
            try {
                ...
                this.vi.getLienzo().setImage(rop.filter(this.imgTemp, null));
                this.imgTemp = null;
                this.setEnabledUndo(true);
    ...
    private void jMenuItemBandCombineOpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemBandCombineOpActionPerformed
        if (this.canApply(BufferedImage.TYPE_INT_ARGB)) {
            ...
            try {
                ...
                this.vi.getLienzo().setImage(new BufferedImage(this.imgOrigen.getColorModel(), rasterdest, false, null));
                this.imgOrigen = this.imgTemp = null;
                this.setEnabledUndo(true);
            } catch (Exception e) {
    ...
    private void jMenuItemColorConvertOpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemColorConvertOpActionPerformed
        if (this.canApply(BufferedImage.TYPE_INT_RGB)) {
            try {
                ...
                this.vi.getLienzo().setImage(ccop.filter(this.imgTemp, null));
                this.imgOrigen = this.imgTemp = null;
                this.setEnabledUndo(true);
            } catch (Exception e) {
    ...
    private void jMenuItemNegativeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemNegativeActionPerformed
        if (this.canApply(BufferedImage.TYPE_INT_ARGB)) {
            try {
                ...
                this.vi.getLienzo().setImage(lop.filter(this.imgTemp, null));
                this.imgOrigen = this.imgTemp = null;
                this.setEnabledUndo(true);
            } catch (Exception e) {
    ...
    protected javax.swing.JLabel jLabelMouseColorPos;
