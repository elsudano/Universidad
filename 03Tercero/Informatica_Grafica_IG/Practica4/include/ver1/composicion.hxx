...
// En este metodo es donde hay que incluir las modificaciones de la parte
// del cuelpo que corresponda, así pues si la figura necesita moverse
// solo esta parte aqui es donde se incluyen las modificaciones
//******************************************************************************
...
void _composicion::antebrazoderecho(int mode){
    ...
    this->parte_cuerpo->leer_objeto(fichero);
    glPushMatrix();
    // desplazamos hacia abajo para que la rotación
    // de los brazos tenga mas sentido
