...
class MainView(View):
    ...
    def _init_view(self):
        ...
        self.b_boton9 = ttk.Button(self.g_group3, text="Mostrar primera Tabla y Gráfica ")
        self.b_boton9.grid(column=4, row=0, sticky='')
        self.b_boton9.bind("<Button>", self._controller.eje_5)
        self.b_boton6 = ttk.Button(self.g_group3, text="2ª Función")
        self.b_boton6.grid(column=0, row=1, sticky='')
        self.b_boton6.bind("<Button>", self._controller.eje_6)
        self.b_boton7 = ttk.Button(self.g_group3, text="1ª BlockChain 2ª Función b=2")
        self.b_boton7.grid(column=1, row=1, sticky='')
        self.b_boton7.bind("<Button>", self._controller.eje_7_a)
        self.b_boton8 = ttk.Button(self.g_group3, text="2ª BlockChain 2ª Función b=3")
        self.b_boton8.grid(column=2, row=1, sticky='')
        self.b_boton8.bind("<Button>", self._controller.eje_7_b)
        self.b_boton9 = ttk.Button(self.g_group3, text="3ª BlockChain 2ª Función b<20")
        self.b_boton9.grid(column=3, row=1, sticky='')
        self.b_boton9.bind("<Button>", self._controller.eje_7_c)
        self.b_boton9 = ttk.Button(self.g_group3, text="Mostrar segunda Tabla y Gráfica")
        self.b_boton9.grid(column=4, row=1, sticky='')
