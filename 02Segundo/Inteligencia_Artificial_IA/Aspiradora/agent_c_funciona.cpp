...
Agent::ActionType Agent::Think()
{
    ...
    P1=P2=P3=P4 = false;
    if (C0==0 and C1>=0 and C2>=0 and C3>=0 and (Direccion==0 or Direccion==1 or Direccion==2 or Direccion==3)){
        P1 = true;
    }
    if (C0>=0 and C1==0 and C2>=0 and C3>=0 and (Direccion==0 or Direccion==1 or Direccion==2 or Direccion==3)){
        P2 = true;
    ...
    if (dirty_){
        ...
        if (P1 and !P2 and P3 and P4){
            ...
            if ((C0==C1) and (C0==C3)){
                ...
                if (C0>C1){
                    if (debug)
                        cout << "Regla !P1 and !P2 and P3 and !P4 1er if" << endl;
                    accion = actTURN_R;
                    Direccion = mod(Direccion+1,4);
                }else if (C0>C3){
                    if (debug)
                        cout << "Regla !P1 and !P2 and P3 and !P4 2do if" << endl;
                    accion = actTURN_L;
                    Direccion = mod(Direccion-1,4);
                }else{
                    if (debug)
            ...
            if (C0>C1 and C1!=0){
                if (debug)
                    cout << "Regla (C0>=C1) or (C0>=C3) 1er if" << endl;
                accion = actTURN_R;
                Direccion = mod(Direccion+1,4);
            }else if (C0>C3  and C3!=0){
                if (debug)
                    cout << "Regla (C0>=C1) or (C0>=C3) 2do if" << endl;
                accion = actTURN_L;
                Direccion = mod(Direccion-1,4);
            }else{
                if (debug)
                    cout << "Regla (C0>=C1) or (C0>=C3) con else" << endl;
//                switch(rand()%3){
//                case 0:
//                    accion = actFORWARD;
//                    break;
    ...
    if (val=="P"){
        ...
        for (int Y=0; Y < tamTablero; ++Y){
            for (int X=0; X < tamTablero; ++X){
                cout << setw(3) << mapa[X+(Y*tamTablero)] << " ";
            }
            cout << endl;
        }
        cout << endl;
