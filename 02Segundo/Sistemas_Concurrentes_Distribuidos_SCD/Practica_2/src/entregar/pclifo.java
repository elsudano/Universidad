...
class BufferLifo extends AbstractMonitor{
...
class ProductorH extends AbstractMonitor implements Runnable{
...
class ConsumidorH extends AbstractMonitor implements Runnable{
	private Object bb;
	int veces; 
	int numC ;
	public Thread thr ;
...
class pclifo {
	public static void main(String[] args) {
		...
		ConsumidorH[] cons1 = new ConsumidorH[Integer.parseInt(args[0])] ; //lista de consumidores
		ProductorH[]  prod1 = new ProductorH[Integer.parseInt(args[1])] ; // lista de productores
		Object bufferFL = null;
		bufferFL = new BufferLifo(Integer.parseInt(args[2]));
