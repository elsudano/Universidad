...
public class VentanaInternaImagen extends javax.swing.JInternalFrame {
    ...
    private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameActivated
        ...
        this.myParent.getSpinnerGrosor().setValue((int) this.JPanelLienzo.getStroke());
        ...
        this.myParent.getToggleButtonAntiAliasing().setSelected(this.JPanelLienzo.getFlatten());
        // si tiene transparencia
        this.myParent.getSpinnerTransparencia().setValue(this.JPanelLienzo.getAlpha());
