...
const int num_items = 40;			// Cantidad de Datos que vamos a Producir
...
int main(int argc,char *argv[]){
	...
	sem_init(&puede_producir, 0, 10);		// este lo ponemos a 1 para que el productor cree un dato
	sem_init(&puede_consumir, 0, -5);		// este lo inicializamos a 0 para que no consuma un vacio
