...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxColor.addMouseWheelListener(new java.awt.event.MouseWheelListener() {
            public void mouseWheelMoved(java.awt.event.MouseWheelEvent evt) {
                jComboBoxColorMouseWheelMoved(evt);
            }
        });
    ...
    private void jMenuItemNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemNuevoActionPerformed
        ...
        this.vi = new VentanaInterna(this);
        ...
        this.jDesktopEscritorio.add(vi);
        this.vi.setVisible(true);
        this.jToggleButtonPunto.setSelected(true);
        this.jToggleButtonPintar.setSelected(true);
        this.jCheckBoxRelleno.setSelected(false);
        this.jSliderGrosor.setValue(4);
    ...
    private void jToggleButtonRellenoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonRellenoActionPerformed
        this.vi = (VentanaInterna) jDesktopEscritorio.getSelectedFrame();
        // poner que hacer con el relleno
    ...
    private void jComboBoxColorMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_jComboBoxColorMouseWheelMoved
        // @TODO tienes que hacer que cuando ruede el ratón cambie la selección
    }//GEN-LAST:event_jComboBoxColorMouseWheelMoved
