...
public class Lienzo extends javax.swing.JPanel {
    ...
    private Point myPointBegin = new Point();
    private Point myPointEnd = new Point();
     ...
     * @param g este es un objeto de gráficos que será el que contenga las formas.
     */
    @Override
    public void paint(Graphics g) {
        ...
        if (myShape.equals("point")){
            if (fill){
               g2d.fillOval(myPointBegin.x - (myStroke / 2), myPointBegin.y - (myStroke / 2), myStroke, myStroke); 
            }else{
                g2d.drawOval(myPointBegin.x - (myStroke / 2), myPointBegin.y - (myStroke / 2), myStroke, myStroke);
            }
    ...
    /**
     * Con este metódo asignamos cual será el punto de finalización
     * para crear la forma.
     ...
     * @param c[in] el comor especificado para la linea y el relleno de la forma.
     */
    ...
    /**
     * Con este metódo asignamos la herramienta que usaremos para pintar en
     * el lienzo.
    ...
    /**
     * Con este metódo asignamos un color de relleno a la forma que vamos a dibujar
     * de tal forma que se rellena si es verdadero y falso en caso contrario.
