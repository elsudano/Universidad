...
public:
	Agent(){
        ...
        bump_ = false;
        dirty_ = false;
        tamTablero = 100; // Cambiando este valor es el tamaño predefinido del tablero
...
//--------------------------------------
	...
	void ActualizarMapa(int X, int Y, bool muro); // Sirve para actualizar la posición del agente en el mapa
};
